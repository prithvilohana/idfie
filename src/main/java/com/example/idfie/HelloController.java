...
public class HelloController {
    ...
    public void generateID(ActionEvent event) throws IOException {
        ...
        if (userPicture == null || user.idNo.isEmpty() || user.firstName.isEmpty() || user.fatherName.isEmpty() || user.phoneNumber.isEmpty() || user.emailAddress.isEmpty() || user.batchNo.isEmpty() || user.campus.isEmpty()) {
            ...
            idCardController.setIdInfo(user.firstName, user.fatherName, user.idNo, user.batchNo, user.campus, user.department, user.emailAddress, user.phoneNumber);
